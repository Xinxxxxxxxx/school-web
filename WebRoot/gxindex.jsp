  ...
  <div class="container"> 
    ...
    <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
      <ul class="nav navbar-nav navbar-right">
        <li><a href="gxlogin.jsp" >登陆</a></li>
        <li><a href="gxregist.jsp" >注册</a></li>
...
<div class="container summary"> 
  ...
  <div class="row wow fadeInDown" data-wow-duration="3s" data-wow-delay="1s" id="summary-container">
    <div class="col-md-4"> <img class="img-circle " src="images/b1.jpg" alt="">
      <h2>书籍</h2>
      <p><a class="btn btn btn-danger btn-lg col-sm-offset-4 col-md-4" href="gxshop.jsp" role="button" >GO</a></p>
    </div>
    <div class="col-md-4"> <img class="img-circle" src="images/b4.jpg" alt="">
      <h2>数码</h2>
      <p><a class="btn btn-primary btn-lg col-sm-offset-4 col-md-4" href="gxshop.jsp" role="button">GO</a></p>
    </div>
    <div class="col-md-4"> <img class="img-circle" src="images/b9.png" alt="">
      <h2>交通</h2>
      <p><a class="btn btn-warning btn-lg col-sm-offset-4 col-md-4" href="gxshop.jsp" role="button">GO</a></p>
    </div>
    <div class="col-md-4"> <img class="img-circle" src="images/b8.png" alt="">
      <h2>运动</h2>
      <p><a class="btn btn-info btn-lg col-sm-offset-4 col-md-4" href="gxshop.jsp" role="button">GO</a></p>
    </div>
    <div class="col-md-4"> <img class="img-circle" src="images/b5.jpg" alt="">
      <h2>盆栽</h2>
      <p><a class="btn btn-success btn-lg col-sm-offset-4 col-md-4" href="gxshop.jsp" role="button">GO</a></p>
    </div>
