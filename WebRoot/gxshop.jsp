...
<div id="sidebar">
  <ul>
    <li id="prof" class="item"> <span class="glyphicon glyphicon-user"> </span>
      <div><a href="personal.jsp">我</a> </div>
    </li>
...
<div class="jumbotron wow slideInDown ">
  <h1>校园闲置物品交易</h1>
  <p >让闲置游起来</p>
  <p><a class="btn btn-primary btn-lg" href="gxpublish.jsp" role="button">发布商品</a></p>
  <input type="text" class="form-control" placeholder="Search for..."><div class="input-group col-sm-3"> <span class="input-group-btn ">
...
<div class="container wow slideInDown">
  <div class="row">
    ...
    <div class="img col-md-4 wow flash " data-wow-duration="1s" data-wow-delay="2s"> <a href="#"> <img src="./images/day1.jpg"></a></br>
      ...
      <div class="time text-danger"> <span class="glyphicon glyphicon-time"></span> <span id="t_d">00天</span> <span id="t_h">01时</span> <span id="t_m">11分</span> <span id="t_s">00秒</span> </div>
      <!--time 结束-->
